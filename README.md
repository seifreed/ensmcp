...
La procedencia de los datos se documenta en [`DATA_LICENSE.md`](DATA_LICENSE.md) y la publicación en el registro MCP consta en [`MCP_REGISTRY.md`](MCP_REGISTRY.md).
